      ...
      <div className="flex flex-col space-y-6">
        {jobs.map((job) => (
          ...
          >
            ...
            <button className=" bg-gradient-to-r bg-[#FFD700] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800  text-black  px-4 py-2 rounded-lg shadow-md w-full md:w-auto">
              Apply Now
            </button>
          </div>
        ))}
