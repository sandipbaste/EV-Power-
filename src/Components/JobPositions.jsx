  ...
  return (
    <div className="container mx-auto my-12 p-6">
      ...
      <div className="flex flex-col space-y-6">
        {jobs.map((job) => (
          ...
          >
            ...
            <button className=" bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800  text-white  px-4 py-2 rounded-lg shadow-md w-full md:w-auto">
              Apply Now
            </button>
          </div>
        ))}
      ...
      <div className="flex justify-center mt-6">
        <button
          onClick={toggleJobs}
          className=" px-6 py-2 rounded-lg shadow-md bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 transition-colors"
        >
