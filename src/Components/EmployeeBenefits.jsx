...
const EmployeeBenefits = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20 ">
          {benefits.map((benefit) => (
            <div key={benefit.id} className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className={`bg-${benefit.color}-500 p-6`}>
                ...
                <ul className="space-y-3">
                  {benefit.items.map((item, index) => (
                    <li key={index} className="flex items-start">
                      <svg className={`h-5 w-5 text-${benefit.color}-500 mr-2 mt-0.5`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
